...
- **The Synthetic Control Solution**: Distributional Synthetic Control uses donor states that share the same rounding behaviors. By matching Hawaii's distribution to a combination of California, Nevada, Florida, and Alaska, the counterfactual naturally expects low counts at 19 and a large peak at 20, cleanly isolating Hawaii's true causal bunching (+7.6x excess at 19 hours).
